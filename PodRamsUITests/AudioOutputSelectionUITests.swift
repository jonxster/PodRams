...
final class AudioOutputSelectionUITests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        app = try MainActor.assumeIsolated { () -> XCUIApplication in
    ...
    func testAudioOutputSelectionView_structure() throws {
        ...
        try MainActor.assumeIsolated {
            ...
            let audioButton = application.buttons["AudioOutputButton"]
            ...
            let selectionView = application.otherElements["AudioOutputSelectionView"]
